...
Download Polar v1.4.1 for your OS

- Mac ([dmg](https://github.com/jamaljsr/polar/releases/download/v1.4.1/polar-mac-v1.4.1.dmg))
- Linux ([deb](https://github.com/jamaljsr/polar/releases/download/v1.4.1/polar-linux-amd64-v1.4.1.deb), [AppImage](https://github.com/jamaljsr/polar/releases/download/v1.4.1/polar-linux-x86_64-v1.4.1.AppImage))
- Windows ([exe](https://github.com/jamaljsr/polar/releases/download/v1.4.1/polar-win-v1.4.1.exe))
